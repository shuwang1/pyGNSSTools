...
with open( CodePhaseSearchConfigFilename, 'rt' ) as f:
    ...
    CodePhaseSearchConfig['Default_Coherent_Integration_Time_MS']           = 16
    CodePhaseSearchConfig['Default_Coherence_Interval_MS']                  = 20
    CodePhaseSearchConfig['Default_Noncoherence_Integration']               = 20
